...
func (x *ChunkMessage) GetChunk() []byte {
	if x != nil {
		return x.Chunk
	}
	return nil
...
func (x *AkMessage) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AkMessage) ProtoMessage() {}

func (x *AkMessage) ProtoReflect() protoreflect.Message {
	mi := &file_proto_proto_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AkMessage.ProtoReflect.Descriptor instead.
func (*AkMessage) Descriptor() ([]byte, []int) {
	return file_proto_proto_proto_rawDescGZIP(), []int{1}
}

func (x *AkMessage) GetAk() string {
	if x != nil {
		return x.Ak
	}
	return ""
...
var file_proto_proto_proto_rawDesc = []byte{
	...
	,
...
var file_proto_proto_proto_goTypes = []interface{}{
	(*ChunkMessage)(nil), // 0: proto.ChunkMessage
	(*AkMessage)(nil),    // 1: proto.AkMessage
}
var file_proto_proto_proto_depIdxs = []int32{
	0, // 0: proto.Service.ChunkStream:input_type -> proto.ChunkMessage
	1, // 1: proto.Service.ChunkStream:output_type -> proto.AkMessage
